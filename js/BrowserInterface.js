...
(function ($) {
  ...
  var makingCentsMessage = function () {
    const html = '<div class="memory-modal makingcents">' +
      ...
      '<p class="memory-modal__small-text" style="text-align:center;">Insured by NCUA</p>' +
      '<p class="memory-modal__image-container" style="text-align:center;"><img src="../images/ehl_logo_bw.jpg" class="memory-modal__image"/></p>' +
      '</div>' +
      '<a href="#" id="memory-modal__close" class="memory-modal__close--js">&times;</a>' +
      '</div>' +
      '</div>';
